...
//Enum class that we used for determining collision
//with the walls and the puck
...
private:
	//Vec3's to get the objects postion, size and velocity
	glm::vec3 position;
	glm:: vec2 size;
	float radius;
	objectTag item;

	//Calls CollisionDetection class as a friend class
