...
int main() {
	...
	// Push another scope so most memory should be freed *before* we exit the app
	{
		...
		Texture2D::sptr reflection = Texture2D::LoadFromFile("images/box-reflections.bmp");
		//TODO LOAD TEXTURE IN
		...
		material0->Set("s_Reflection", reflection);
