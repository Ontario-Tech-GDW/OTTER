...
glCreateTextures(GL_TEXTURE_2D, 1, &_handle);
	...
	if(_description.Width * _description.Height > 0 && _description.Format != InternalFormat::Unknown) { glTextureStorage2D(_handle, 1, *_description.Format, _description.Width, _description.Height);    
