...
bool initGLFW() {
	...
	window = glfwCreateWindow(800, 800, "Christian_Riggi - 100752293", nullptr, nullptr);
...
int main() {
	...
	static const float interleaved[] = { 
		...
		0.9f,  0.9f, 0.5f,  0.3f, 0.2f, 0.5f,
		-0.2f,  0.9f, 0.5f,  1.0f, 1.0f, 0.0f, 
		0.9f,  0.5f, 0.5f,  1.0f, 1.0f, 1.0f   
	};   
	...
	//glDrawElements uses index buffer to determine shape of triangle
