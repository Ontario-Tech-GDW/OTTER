...
bool initGLFW() {
	...
	window = glfwCreateWindow(800, 800, "Christian_Riggi_100752293", nullptr, nullptr);
...
int main() {
	...
	//New pointer variables are created and load in the value stored within the new points and colors array.
	VertexBuffer::sptr posVbo_2 = VertexBuffer::Create();
	posVbo_2->LoadData(points2, 9);
...
//Second Vertax array object created to draw 3rd object
	VertexArrayObject::sptr vao3 = VertexArrayObject::Create();

	vao3->AddVertexBuffer(posVbo_2, {
	...
	camera->SetPosition(glm::vec3(0, 3, -1));   
	...
	while (!glfwWindowShouldClose(window)) {
		...
		transform3 = glm::rotate(glm::mat4(1.0f), static_cast<float>(thisFrame), glm::vec3(1,0,1));
